(function () {
  ...
  angular.module('app.core')
    .directive('msgCenter', MsgCenterDirective);

  MsgCenterDirective.$inject = [];

  /* @ngInject */
  function MsgCenterDirective() {
    return {
      restrict: 'E',
      templateUrl: 'app/core/components/msgCenter/msgCenter.html',
      controller: MsgCenterController,
      controllerAs: '$ctrl'
    };
  }

  MsgCenterController.$inject = ['$sce'];

  function MsgCenterController($sce) {
    var vm = this;
    vm.users = {
      0: {
        name: 'Vlad'
    ...
    function getMessage(msg) {
      ...
      if (msg.userId || msg.userId === 0) {
        text = text.replace('&name', '<strong>' + vm.users[msg.userId].name + '</strong>');
      }
