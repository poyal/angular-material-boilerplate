(function () {
  ...
  angular.module('app.examples.dashboard')
    .directive('dashboardLineChart', DashboardLineChartDirective);

  DashboardLineChartDirective.$inject = [];

  function DashboardLineChartDirective() {
    return {
      restrict: 'E',
      controller: DashboardLineChartController,
      templateUrl: 'app/examples/dashboard/components/dashboardLineChart/dashboardLineChart.html'
    };
  }

  DashboardLineChartController.$inject = ['baConfig', 'layoutPaths', 'baUtil'];

  function DashboardLineChartController(baConfig, layoutPaths, baUtil) {
