(function () {
  ...
  angular
    ...
    .directive('blurFeed', BlurFeedDirective);

  BlurFeedDirective.$inject = [];

  function BlurFeedDirective() {
    return {
      restrict: 'E',
      controller: BlurFeedController,
      controllerAs: '$ctrl',
      templateUrl: 'app/examples/dashboard/components/blurFeed/blurFeed.html'
    };
  }

  BlurFeedController.$inject = [];

  function BlurFeedController() {
    var vm = this;
    vm.feed = [
      {
        type: 'text-message',
