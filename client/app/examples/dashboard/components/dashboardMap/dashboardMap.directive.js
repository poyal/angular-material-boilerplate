(function () {
  ...
  angular.module('app.examples.dashboard')
    .directive('dashboardMap', DashboardMapDirective);

  DashboardMapDirective.$inject = [];

  function DashboardMapDirective() {
    return {
      restrict: 'E',
      controller: DashboardMapController,
      templateUrl: 'app/examples/dashboard/components/dashboardMap/dashboardMap.html'
    };
  }

  DashboardMapController.$inject = ['baConfig', 'layoutPaths'];

  function DashboardMapController(baConfig, layoutPaths) {
